...
var adOption = new Object();
 ...
 adOption.selOpt = function(opt, txtbox) { document.getElementById(txtbox).value = opt; }
  ...
  function alertNotification(){
	  if(document.getElementById("alertNotify").value =="EMAIL"){
  ...
  function selectFileListVal(){
	  var x = document.getElementById('patternList');
	     ...
	     var x = document.getElementById('lowpatternList');
	     var val = "";
	     for (var i = 0; i < x.length; i++) {
	         val=val+x[i].value + ",";
	      }
	     document.getElementById('lowpatternListVal').value=val;
...
<input type="hidden" name="lowpatternListVal" id="lowpatternListVal" /> 
<tr>
<td>  High Risk Pattern: </td> <td><input type="text" name="optval" id="optval" /></td>
...
<tr>
<td>  Low Risk Pattern: </td> <td><input type="text" name="lPatVal" id="lPatVal" /></td>
<td><table><tr><td> <input type="button" id="lowPat" name="lowPat" value=">" onclick="adOption.addOption('lowpatternList', 'lPatVal');" />
</td><tr><td>
  <input type="button" id="low_del_opt" name="low_del_opt" value="<" onclick="adOption.delOption('lowpatternList', 'lPatVal');" />
  
</td>
<td>
  <select multiple="true" name="lowpatternList" id="lowpatternList"  onchange="adOption.selOpt(this.value, 'lPatVal')" style="width: 150px; height: 70px; margin: 0px 2px 0px 3px;">></select></td>
 </tr></table></td>
