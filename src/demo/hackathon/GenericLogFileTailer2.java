 ...
 * Siva Adabala
 */
public class GenericLogFileTailer2 extends Thread 
{
  /**
   ...
   */
  public GenericLogFileTailer2( File file )
  {
    this.logfile = file;
  }
   ...
   *               end of the file
   */
  public GenericLogFileTailer2( File file, long sampleInterval, boolean startAtBeginning )
  {
    this.logfile = file;
    this.sampleInterval = sampleInterval;
  }

  public void addLogFileTailerListener( GenericLogFileTailerListener l )
  {
    this.listeners.add( l );
  }

  public void removeLogFileTailerListener( GenericLogFileTailerListener l )
  {
  ...
  protected void fireNewLogFileLine( String line )
  {
    ...
    {
    	GenericLogFileTailerListener l = ( GenericLogFileTailerListener )i.next();
